...
static kernel_mod_info_t g_mod_info = {
    ...
    .version_code = 2026091031,
    .api_version = 1,
    .version = "1.0.31-v06-name-color-render-fix-arm64"
};
...
static void init_mod(kernel_mod_handle_t *handle) {
    ...
    OR_LOG(MOD_LOG_LEVEL_INFO,
           "[MODULE_BEACON] version=1.0.31-v06-name-color-render-fix-arm64 versionCode=2026091031 stage=enter");
    OR_LOG(MOD_LOG_LEVEL_INFO,
    ...
    OR_LOG(MOD_LOG_LEVEL_INFO, "[HOOK_STATE] version=1.0.31-v06-name-color-render-fix-arm64 gameplay=%s metadata=%s",
           g_runtime.capabilities.gameplay_enabled ? "on" : "off",
           "PatchLib");
    OR_LOG(MOD_LOG_LEVEL_INFO,
           "[MODULE_BEACON] version=1.0.31-v06-name-color-render-fix-arm64 versionCode=2026091031 stage=ready");
}
