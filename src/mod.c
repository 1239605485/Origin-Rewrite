...
static kernel_mod_info_t g_mod_info = {
    ...
    .version_code = 2026090425,
    .api_version = 1,
    .version = "0.2.4-crash-isolation"
};
...
static void init_mod(kernel_mod_handle_t *handle) {
    ...
    OR_LOG(MOD_LOG_LEVEL_INFO,
           "[MODULE_BEACON] version=0.2.4-crash-isolation versionCode=2026090425 stage=enter");
    ...
    OR_LOG(MOD_LOG_LEVEL_INFO, "[HOOK_STATE] version=0.2.4-crash-isolation gameplay=%s",
           g_runtime.capabilities.gameplay_enabled ? "on" : "off");
    OR_LOG(MOD_LOG_LEVEL_INFO,
           "[MODULE_BEACON] version=0.2.4-crash-isolation versionCode=2026090425 stage=ready");
}
