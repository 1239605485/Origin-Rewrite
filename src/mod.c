...
static kernel_mod_info_t g_mod_info = {
    ...
    .version_code = 2026090423,
    .api_version = 1,
    .version = "0.2.2-authority-visual"
};
...
static void init_mod(kernel_mod_handle_t *handle) {
    ...
    OR_LOG(MOD_LOG_LEVEL_INFO,
           "[MODULE_BEACON] version=0.2.2-authority-visual versionCode=2026090423");
    ...
    OR_LOG(MOD_LOG_LEVEL_INFO, "[HOOK_STATE] version=0.2.2-authority-visual gameplay=%s",
