...
static kernel_mod_info_t g_mod_info = {
    ...
    .version_code = 2026090431,
    .api_version = 1,
    .version = "0.3.0-name-display-source"
};
...
static void init_mod(kernel_mod_handle_t *handle) {
    ...
    OR_LOG(MOD_LOG_LEVEL_INFO,
           "[MODULE_BEACON] version=0.3.0-name-display-source versionCode=2026090431 stage=enter");
    ...
    OR_LOG(MOD_LOG_LEVEL_INFO, "[HOOK_STATE] version=0.3.0-name-display-source gameplay=%s",
           g_runtime.capabilities.gameplay_enabled ? "on" : "off");
    OR_LOG(MOD_LOG_LEVEL_INFO,
           "[MODULE_BEACON] version=0.3.0-name-display-source versionCode=2026090431 stage=ready");
}
