...
typedef struct OR_LootConfig {
    ...
    /* Direct Item.NewItem is ABI-sensitive on Android. Keep it opt-in even
     * when the metadata probe finds a matching overload. */
    bool enable_native_extra_item;
} OR_LootConfig;
